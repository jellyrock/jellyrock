...
const SPELL_EXACT = new Set([
  ...
  // Generated by scripts/screenshots-index.js — full of native language names
  // (Français, Deutsch, …, eventually ~99 incl. non-Latin scripts) that aren't
  // dictionary words and can't all be enumerated.
