...
- **Live TV channel** — `playCurrentQueueItem()` (restart the same channel by remounting), unless it keeps ending without playing: then the playback error shows instead (see [`playback.md`](./playback.md))
