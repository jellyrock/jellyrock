...
- Don't add behavior to a Jellyfin schema file (the strict rule above) unless you're following the `JellyfinUserSettings.bs` precedent for a similarly deliberate persistence pattern.
