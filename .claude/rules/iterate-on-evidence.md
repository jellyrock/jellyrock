...
The evidence gate targets **speculative features** ("we might need this if we add a fourth consumer"). It does **not** gate these — act on them now:

- **A defect or duplication that already exists.** Copy-pasted boilerplate that will drift, a bug sitting in the tree — if you can point at it, the defect *is* the evidence.
